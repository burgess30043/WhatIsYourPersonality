...
/**
 * Create a class for the Car type Sedan
 * @author Burgess
 */
public class Sedan extends Car{
    ...
    /**
     * A constructor for the Sedan class
     * @param cl is the car logo extends from the parent class car
     * @param type is the car type Sedan
     */
    public Sedan(CarLogo cl, String type) {
        super(cl);
        setType(type);
    }
    ...
    public String carTypeDescription(){
        ...
        String s = "";
        s+="Sedan is a normal family vehicle!";
